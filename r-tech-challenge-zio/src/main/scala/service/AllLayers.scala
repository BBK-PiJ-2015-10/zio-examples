...
import service.internal.{BiProcessor, OrchestratorWithSourceCounter}
import zio._
...
object AllLayers {
  ...
  val orchestratorLayer = OrchestratorWithSourceCounter.layer()

  //val totalSources: UIO[Ref[Int]] = Ref.make(2)

  val biProcessor = BiProcessor.layer
